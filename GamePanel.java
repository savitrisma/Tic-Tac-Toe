...
public class GamePanel extends JPanel implements ActionListener {
	...
	// COLORS
	Color turtle = new Color(0xabddf2);
	Color orange = new Color(0xfdcb9);
	...
	public void drawUI(Graphics page) {
		...
		page.drawString("Menang", 310, 30);
		page.drawString(": " + player1wins, 362, 70);
		page.drawString(": " + player2wins, 362, 105);

		// DRAW score X
		ImageIcon xIcon = new ImageIcon("silang.png");
		...
		if (gameDone) {
			...
			page.setFont(font2);
			page.drawString("Giliran", 350, 160);
			if (playerX) {
				page.drawString("X main", 325, 180);
			} else {
				page.drawString("O main", 325, 180);
			}
		}
		// DRAW LOGO
